describe "my_collect"
  ...
  #it "returns a new collection of appropriately modified elements, in this case capitalized languages" 
  do
    (my_collect(languages) do |language|
      language.upcase
    end
    #).to eq(["RUBY", "JAVASCRIPT", "PYTHON", "OBJECTIVE-C"])
  end
  ...
  #it "yields the correct element from the given collection, in this case students" 
  do
